...
public:
    ...
    std::optional<models::Member>  get_member(const std::string& server_id, const std::string& user_id) const;
    size_t                         get_member_count_sync(const std::string& server_id) const;
    size_t                         get_total_member_count() const;
